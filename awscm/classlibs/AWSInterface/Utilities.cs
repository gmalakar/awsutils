...
namespace AWSCM.AWSInterface
{
   public static class Utilities
   {
      ...
      public static bool TryCreateIAMPolicy( out string message, string roleName, string jsonPolicyDocument, string description = null )
      {
         return IAM.TryCreatePolicy( out message, roleName, jsonPolicyDocument, description );
      }

      public static bool TryDeletePolicy( out string message, string policyName )
      {
         return IAM.TryDeletePolicy( out message, policyName );
      }
      ...
      public static string LastCreatedIAMPolicy
      {
         get { return  CommonShared.CacheManager.Get(  AWSCacheManager.Constants.LAST_CREATED_POLICY_NAME_KEY ); }
      }
